...
import annotator_service as service
...
class TestService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for other_images in dummy_images_set_2:
            with open(os.path.join(test_root_path, "test run 1", "0000000002", "000000000002", other_images),
                      'w') as files:
                files.write("written")
        ...
        with open(os.path.join(test_root_path, "test run 1", "0000000001", "000000000001", "000000000001.json"),
                  'w') as json_file:
            json_file.write(json_text_1)
        with open(os.path.join(test_root_path, "test run 1", "0000000002", "000000000002", "000000000002.json"),
                  'w') as json_file:
